        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-3xl mx-auto">
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold" style={{ color: '#16a34a' }}>300+</div>
              <div className="text-gray-800 text-base md:text-lg font-medium">Tevreden Klanten</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold" style={{ color: '#16a34a' }}>24/7</div>
              <div className="text-gray-800 text-base md:text-lg font-medium">Service Beschikbaar</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold" style={{ color: '#16a34a' }}>5+</div>
