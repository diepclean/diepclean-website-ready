    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-2xl text-gray-800 mb-8 leading-relaxed font-medium drop-shadow-md">
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center mb-12 md:mb-16">
            <OfferteDialog>
              <Button 
                size="lg" 
                className="bg-blue-600 hover:bg-blue-700 text-white px-6 md:px-10 py-4 md:py-6 text-lg md:text-xl shadow-xl rounded-xl w-full sm:w-auto"
              >
            ...
            <Button 
              size="lg" 
              onClick={onWhatsApp}
              className="text-white px-6 md:px-10 py-4 md:py-6 text-lg md:text-xl shadow-xl rounded-xl w-full sm:w-auto"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-3xl mx-auto">
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold drop-shadow-md" style={{ color: '#16a34a' }}>300+</div>
              <div className="text-gray-800 text-base md:text-lg font-medium">Tevreden Klanten</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold drop-shadow-md" style={{ color: '#16a34a' }}>24/7</div>
              <div className="text-gray-800 text-base md:text-lg font-medium">Service Beschikbaar</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold drop-shadow-md" style={{ color: '#16a34a' }}>5+</div>
